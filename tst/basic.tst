...
gap> Comp(5, [VoleCon.SetStab([2,3,4]), VoleCon.SetStab([3,4,5])]);
gap> Comp(7, [VoleCon.SetStab([2,3,4]), VoleCon.TupleStab([5])]);
gap> Comp(5, [VoleCon.SetStab([2,3,4]), VoleCon.TupleStab([5])]);
gap> Comp(5, [VoleCon.DigraphStab([[2,4],[1,3],[2,4],[1,3],[]])]);
gap> Comp(5, [BTKit_Con.SetStab(5, [2,3])]);
gap> Comp(12, [VoleCon.DigraphStab(neigh)]);
